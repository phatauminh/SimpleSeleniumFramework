...
public class PassionTeaCoWelcomePO<M extends WebElement> extends PassionTeaCoBasePO<M> {
    ...
    public static enum WELCOME_PAGE_IMG {
        PASSION_TEA_CO, LEAF, ORGANIC, TEA_CUP, HERBAL_TEA, LOOSE_TEA,
        FLAVORED_TEA
    }

    public static enum MENU_LINKS {
...
// abstract methods
    ...
    public void navigateMenuLink(MENU_LINKS link, String title)  throws Exception {
        ...
        catch (Exception e)
        {
            ...
            executor.executeScript("arguments[0].scrollIntoView(true);", driver.findElement(By.xpath(query)));
            driver.findElement(By.xpath(query)).click();
        }
